...
namespace BRMS
{
    public partial class PurchaseDetail : Form
    {
        ...
        public PurchaseDetail()
        {
            ...
            panelDataGrid.Controls.Add(DgrPurdetail.Dgv);
            DgrPurdetail.Dgv.Dock = DockStyle.Fill;
            GridForm();
        ...
        private void TypeToggleSwiching()
        {
            if (typeToggle == false)
            {
                ...
                purType = 2;
                if (DgrPurdetail.Dgv.RowCount > 1)
                {
                    PurReturn();
                }
            }
        ...
        private void PurReturn()
        {
            ...
            for(int index = 0; index < DgrPurdetail.Dgv.RowCount-1; index++)
            {
                if(typeToggle==false)
                {
                    DgrPurdetail.Dgv.CellValueChanged -= DataGridCellChangedEvent;
                    int qty = DgrPurdetail.ConvertToInt(DgrPurdetail.Dgv.Rows[index].Cells["purdQty"].Value);
                    DgrPurdetail.Dgv.Rows[index].Cells["purdQty"].Value = (qty * -1).ToString();
                }
            }
            for (int index = 0; index < DgrPurdetail.Dgv.RowCount - 1; index++)
            {
        ...
        {
            DgrPurdetail.Dgv.Columns.Add("purdPdtCode", "제품코드");
            DgrPurdetail.Dgv.Columns.Add("purdPdtTax", "");
            DgrPurdetail.Dgv.Columns.Add("purdPdtNumber", "제품번호");
            DgrPurdetail.Dgv.Columns.Add("purdPdtNameKr", "제품명(한글)");
            DgrPurdetail.Dgv.Columns.Add("purdPdtNameEn", "제품명(영문)");
            DgrPurdetail.Dgv.Columns.Add("purdBprice", "매입단가");
            DgrPurdetail.Dgv.Columns.Add("purdQty", "수량");
            DgrPurdetail.Dgv.Columns.Add("purdAmount", "매입액");
            DgrPurdetail.Dgv.Columns.Add("purdStatus", "상태");

            DgrPurdetail.Dgv.Columns["purdPdtCode"].Visible = false;
            DgrPurdetail.Dgv.Columns["purdStatus"].Visible = false;
            //포멧설정
            ...
            DgrPurdetail.Dgv.Columns["purdPdtNumber"].Width = 120;
            DgrPurdetail.Dgv.Columns["purdPdtNameKr"].Width = 210;
            DgrPurdetail.Dgv.Columns["purdPdtNameEn"].Width = 210;
            DgrPurdetail.Dgv.Columns["purdBprice"].Width = 119;
            DgrPurdetail.Dgv.Columns["purdQty"].Width = 40;
            DgrPurdetail.Dgv.Columns["purdAmount"].Width = 140;

            DgrPurdetail.Dgv.Columns["No"].ReadOnly = true;
            DgrPurdetail.Dgv.Columns["purdPdtNameKr"].ReadOnly = true;
            DgrPurdetail.Dgv.Columns["purdPdtNameEn"].ReadOnly = true;

            foreach (DataGridViewColumn column in DgrPurdetail.Dgv.Columns)
            {
                column.SortMode = DataGridViewColumnSortMode.NotSortable;
            }
            DgrPurdetail.Dgv.Rows.Add();
            DgrPurdetail.Dgv.Rows[0].Cells[0].Value = "1";
            DgrPurdetail.Dgv.Columns["purdBprice"].ReadOnly = true;
            DgrPurdetail.Dgv.Columns["purdQty"].ReadOnly = true;
            DgrPurdetail.Dgv.Columns["purdAmount"].ReadOnly = true;
        ...
        private void GridFill(DataTable dataTable)
        {
            ...
            foreach (DataRow dataRow in dataTable.Rows)
            {
                ...
                DgrPurdetail.Dgv.Rows[rowIndex].Cells["purdBprice"].Value = Convert.ToDouble(dataRow["purd_bprice"].ToString());
                DgrPurdetail.Dgv.Rows[rowIndex].Cells["purdQty"].Value = Convert.ToDecimal(dataRow["purd_qty"].ToString());
                DgrPurdetail.Dgv.Rows[rowIndex].Cells["purdAmount"].Value = Convert.ToDecimal(dataRow["purd_amount"].ToString());
                DgrPurdetail.Dgv.Rows[rowIndex].Cells["purdStatus"].Value = dataRow["purd_Status"].ToString();
                DgrPurdetail.Dgv.Rows[rowIndex].Cells["purdBprice"].ReadOnly = false;
                DgrPurdetail.Dgv.Rows[rowIndex].Cells["purdQty"].ReadOnly = false;
                DgrPurdetail.Dgv.Rows[rowIndex].Cells["purdAmount"].ReadOnly = false;
                DgrPurdetail.Dgv.Rows[rowIndex].Cells["purdPdtNumber"].ReadOnly = true;
                if(dataRow["purd_status"].ToString() =="0")
                {
                    DgrPurdetail.Dgv.Rows[rowIndex].Visible = false;
                }
                rowIndex++;
            }
            LastGridAdd();
        ...
        private void GridNumberSetting()
        {
            ...
            for (int index = 0; index < DgrPurdetail.Dgv.RowCount-1; index++) 
            {
                if(DgrPurdetail.Dgv.Rows[index].Cells["purdStatus"].Value.ToString() == "1")
                {
                    DgrPurdetail.Dgv.Rows[index].Cells["No"].Value = number;
                    number++;
                }
            }
        }
        ...
        {
            if (DgrPurdetail.Dgv.Rows.Count > 0)
            {
                DataGridViewRow lastRow = DgrPurdetail.Dgv.Rows[DgrPurdetail.Dgv.Rows.Count - 1];
        ...
        private void SearchPdtNumberForCode(int currentIndex)
        {
            ...
            try
            {
                ...
                if(string.IsNullOrEmpty(resultObj?.ToString()))
                {
                    ...
                    DgrPurdetail.Dgv.Rows[currentIndex].Cells["purdPdtCode"].Value = "0";
                    DgrPurdetail.Dgv.Rows[currentIndex].Cells["purdStatus"].Value = "1";
                    DgrPurdetail.Dgv.Rows[currentIndex].Cells["purdPdtTax"].Value = "과";
                    //DgrPurdetail.Dgr.Rows[currentIndex].Cells["purdPdtNumber"].Value = resultObj.ToString();
                    DgrPurdetail.Dgv.Rows[currentIndex].Cells["purdPdtNameKr"].Value = DgrPurdetail.Dgv.CurrentRow.Cells["purdPdtNumber"].Value.ToString();
                    DgrPurdetail.Dgv.Rows[currentIndex].Cells["purdPdtNameEn"].Value = DgrPurdetail.Dgv.CurrentRow.Cells["purdPdtNumber"].Value.ToString();
                    DgrPurdetail.Dgv.Rows[currentIndex].Cells["purdBprice"].Value = "0";
                    DgrPurdetail.Dgv.Rows[currentIndex].Cells["purdQty"].Value = "1";
                    DgrPurdetail.Dgv.Rows[currentIndex].Cells["purdAmount"].Value = "0";
        ...
        private void PurchasPriceChanged(int index)
        {
            ...
            string cellValue = DgrPurdetail.Dgv.Rows[index].Cells["purdBprice"].Value as string;
            Decimal qty = Convert.ToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdQty"].Value.ToString());
            Decimal amount = Convert.ToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value.ToString());
            ...
            if(cellValue.Contains("-"))
            {
                ...
                DgrPurdetail.Dgv.Rows[index].Cells["purdBprice"].Value = (amount/ qty).ToString();//원래 가격으로 복귀;
            }
            else
            {
                try
                {
                    DgrPurdetail.Dgv.CellValueChanged -= DataGridCellChangedEvent;
                    DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value = price * qty;
                }
            catch(Exception ex)
            {
        ...
        {
            string cellValue = DgrPurdetail.Dgv.Rows[index].Cells["purdQty"].Value.ToString().Replace(",","");
            
            //purdQty의 값이 공란 또는 Null일 경우 별도 경고문 생성 후 값을 0으로 강제전환
            if (string.IsNullOrWhiteSpace(cellValue))
            {
                MessageBox.Show("수량은 공란으로 설정 할 수 없습니다\n 정확한 수량을 입력하세요", "알림");
                DgrPurdetail.Dgv.Rows[index].Cells["purdQty"].Value = "0";
            }
            ...
            else
            {
                ...
                {
                    DgrPurdetail.Dgv.CellValueChanged -= DataGridCellChangedEvent;
                    decimal price = Convert.ToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdBprice"].Value);
                    decimal qty = Convert.ToDecimal(cellValue);
                    if (purType != 1)
                    {
                        qty = qty * -1;
                        DgrPurdetail.Dgv.Rows[index].Cells["purdQty"].Value = (qty).ToString();
                    }
                    DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value = (price * qty).ToString();
                }
                catch (Exception ex)
                {
                    MessageBox.Show("숫자 형식이 올바르지 않습니다. " + ex.Message, "오류");
        ...
        {
            Decimal qty = Convert.ToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdQty"].Value.ToString());
            Decimal price = Convert.ToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdBprice"].Value.ToString());
            string cellValue = DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value as string;
            ...
            if(cellValue.Contains("-")) // 마이너스 수량 입력 불가
            {
                ...
                DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value = (qty * price).ToString();//원래 가격으로 복귀;
            }
            else
            {
                try
                {
                    ...
                    DgrPurdetail.Dgv.Rows[index].Cells["purdBprice"].Value = (amount / qty).ToString();
                }
                catch(Exception ex)
                {
                    MessageBox.Show("숫자 형식이 올바르지 않습니다. " + ex.Message, "오류");
        ...
        private void InsertPurchaseDetail(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            for(int index = 0; index < DgrPurdetail.Dgv.RowCount -1; index++)
            {
                ...
                purdPdt = DgrPurdetail.Dgv.Rows[index].Cells["purdPdtCode"].Value.ToString();
                purdQty = DgrPurdetail.Dgv.Rows[index].Cells["purdQty"].Value.ToString();
                SqlParameter[] parameters =
                {
                    ...
                    new SqlParameter("@purdBprice",SqlDbType.Float){Value = DgrPurdetail.ConvertToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdBprice"].Value)},
                    new SqlParameter("@purdAmount",SqlDbType.Int){Value = DgrPurdetail.ConvertToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value)},
                    new SqlParameter("@purdSeq",SqlDbType.Int){Value = index +1 },
                    new SqlParameter("@purdStatus",SqlDbType.Int){Value = DgrPurdetail.Dgv.Rows[index].Cells["purdStatus"].Value.ToString()}
                };
                dbconn.ExecuteNonQuery(query, connection, transaction, parameters);
                ...
                {
                    int pdtCode = DgrPurdetail.ConvertToInt(DgrPurdetail.Dgv.Rows[index].Cells["purdPdtCode"].Value); // 제품 코드 추출
                    string pdtName = DgrPurdetail.Dgv.Rows[index].Cells["purdPdtNameKr"].Value.ToString();
                    string pdtNumber = DgrPurdetail.Dgv.Rows[index].Cells["purdPdtNumber"].Value.ToString();
        ...
        private void SetTextBox()
        {
            ...
            for(int index = 0; index < DgrPurdetail.Dgv.RowCount -1; index++)
            {
                if( DgrPurdetail.Dgv.Rows[index].Cells["purdPdtTax"].Value.ToString() == "과" && DgrPurdetail.Dgv.Rows[index].Cells["purdStatus"].Value.ToString() =="1")
                {
                    taxable = taxable + Convert.ToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value.ToString());
                }
                else if(DgrPurdetail.Dgv.Rows[index].Cells["purdPdtTax"].Value.ToString() == "면" && DgrPurdetail.Dgv.Rows[index].Cells["purdStatus"].Value.ToString() == "1")
                {
                    taxfree = taxfree + Convert.ToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value.ToString());
                }
                amount = amount + Convert.ToDecimal(DgrPurdetail.Dgv.Rows[index].Cells["purdAmount"].Value.ToString());
        ...
        {
            if(DgrPurdetail.Dgv.CurrentRow.Index == DgrPurdetail.Dgv.Rows.Count-1)//DataGrid의 마지막행은 항상 비어 있으므로 마지막행 선택시 메시지박스 표시
            {
            ...
            else
            {
                ...
                int pdtCode = DgrPurdetail.ConvertToInt(DgrPurdetail.Dgv.CurrentRow.Cells["purdPdtCode"].Value);
                ...
                else//등록되지 않은 제품의 경우 ProductDetail의 타입을 등록으로 호출하여 데이터 그리드에 있는 정보를 입력하여 한다
                {
                    ...
                    string pdtNumber = DgrPurdetail.Dgv.CurrentRow.Cells["purdPdtNumber"].Value.ToString();
                    string pdtBprice = DgrPurdetail.Dgv.CurrentRow.Cells["purdBprice"].Value.ToString();
