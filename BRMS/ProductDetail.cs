...
namespace BRMS
{
    public partial class ProductDetail : Form
    {
       ...
       /// </summary>
        ...
        {
            panelOrder.Controls.Add(dgrPurchase.Dgv);
            panelSale.Controls.Add(dgrSales.Dgv);
            panelStock.Controls.Add(dgrLog.Dgv);

            dgrPurchase.Dgv.Dock = DockStyle.Fill;
            dgrPurchase.Dgv.Columns.Add("purDate", "매입일");
            dgrPurchase.Dgv.Columns.Add("purType", "구분");
            dgrPurchase.Dgv.Columns.Add("purQty", "매입량");
            dgrPurchase.Dgv.Columns.Add("purAmount", "매입액");
            dgrPurchase.Dgv.Columns.Add("purBprice", "매입단가");
            dgrPurchase.Dgv.Columns.Add("purSupplier", "공급사");
            dgrPurchase.Dgv.ReadOnly = true;
            ...
            dgrSales.Dgv.Dock = DockStyle.Fill;
            dgrSales.Dgv.Columns.Add("saleDate", "판매일");
            dgrSales.Dgv.Columns.Add("saleType", "유형");
            dgrSales.Dgv.Columns.Add("saleAmount", "판매액");
            dgrSales.Dgv.Columns.Add("saleSprice", "판매단가");
            dgrSales.Dgv.Columns.Add("saleBprice", "판매원가");
            dgrSales.Dgv.Columns.Add("saleQty", "판매수량");
            dgrSales.Dgv.Columns.Add("saleCustomer", "고객");
            dgrSales.Dgv.Columns.Add("saleCode", "판매코드");
            dgrSales.Dgv.ReadOnly = true;
            dgrSales.Dgv.Columns["saleCode"].Visible = false;
            dgrSales.Dgv.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
        ...
        {
            int saleCode = dgrSales.ConvertToInt(dgrSales.Dgv.CurrentRow.Cells["saleCode"].Value);
        ...
        {
            dgrPurchase.Dgv.Rows.Clear();
            foreach (DataRow rusltRow in dataTable.Rows)
            {
                var rowIndex = dgrPurchase.Dgv.Rows.Add();
                var row = dgrPurchase.Dgv.Rows[rowIndex];
        ...
        {
            dgrSales.Dgv.Rows.Clear();
            foreach (DataRow resultRow in dataTable.Rows)
            {
                var rowIndex = dgrSales.Dgv.Rows.Add();
                var row = dgrSales.Dgv.Rows[rowIndex];
                object resultObj = new object();
