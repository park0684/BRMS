...
namespace BRMS
{
    public partial class PurchaseLog : Form
    {
        ...
        {
            dgrLog.Dgv.Columns.Add("logOrderType", "구분");
            dgrLog.Dgv.Columns.Add("logSupname", "공급사명");
            dgrLog.Dgv.Columns.Add("logSupCode", "코드");
            dgrLog.Dgv.Columns.Add("logPurDate", "매입/발주일");
            dgrLog.Dgv.Columns.Add("logParam", "파라메터");
            dgrLog.Dgv.Columns.Add("logParam2", "상세");
        ...
        private void FillGrid(DataTable dataTable)
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                dgrLog.Dgv.Rows[addRow].Cells["logOrderType"].Value = orderType;
                dgrLog.Dgv.Rows[addRow].Cells["logSupname"].Value = supName;
                dgrLog.Dgv.Rows[addRow].Cells["logSupCode"].Value = supcode;
                dgrLog.Dgv.Rows[addRow].Cells["logParam"].Value = Convert.ToInt32(row["purlog_param"]);
                dgrLog.Dgv.Rows[addRow].Cells["logParam2"].Value = parameter2;
                dgrLog.Dgv.Rows[addRow].Cells["logPurDate"].Value = purDate;
