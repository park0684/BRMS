...
namespace BRMS
{
    public partial class CustomerOrderDetail : Form
    {
        ...
        cDataGridDefaultSet DgvOrderDetail = new cDataGridDefaultSet();
        ...
        public CustomerOrderDetail()
        {
            ...
            panelDataGrid.Controls.Add(DgvOrderDetail.Dgv);
            DgvOrderDetail.Dgv.Dock = DockStyle.Fill;
            ...
            GridFrom();
            GridNumberSetting();
            DgvOrderDetail.Dgv.CellBeginEdit += Dgr_CellBeginEdit;
            DgvOrderDetail.Dgv.CellValueChanged += DataGridCellChangedEvent;
            ...
            DgvOrderDetail.Dgv.MouseClick += DgvOrderDetail_MouseRightClick;
        }
        ...
        {
            DgvOrderDetail.Dgv.Columns.Add("custOrddPdtCode", "제품코드");
            DgvOrderDetail.Dgv.Columns.Add("custOrddPdtNameKr", "제품명(한글)");
            DgvOrderDetail.Dgv.Columns.Add("custOrddPdtNameUs", "제품명(영문)");
            DgvOrderDetail.Dgv.Columns.Add("custOrddPdtNumber", "제품번호");
            DgvOrderDetail.Dgv.Columns.Add("custorddPdtStatus", "제품상태");
            DgvOrderDetail.Dgv.Columns.Add("custOrddOrderQty", "주문수량");
            DgvOrderDetail.Dgv.Columns.Add("custOrddPdtBprice", "매입단가");
            DgvOrderDetail.Dgv.Columns.Add("custOrddPdtSprice", "판매공급가");
            DgvOrderDetail.Dgv.Columns.Add("custOrddOfferPriceKrw", "제안단가(￦)");
            DgvOrderDetail.Dgv.Columns.Add("custOrddOfferPriceUsd", "제안단가(＄)");
            DgvOrderDetail.Dgv.Columns.Add("custOrddOfferQty", "판매수량");
            DgvOrderDetail.Dgv.Columns.Add("custOrddOfferAmounteKrw", "제안액(￦)");
            DgvOrderDetail.Dgv.Columns.Add("custOrddOfferAmounteUsd", "제안액(＄)");
            DgvOrderDetail.Dgv.Columns.Add("custOrddMargin", "이익율");
            DgvOrderDetail.Dgv.Columns.Add("custOrddProfitKrw", "이익액(￦)");
            DgvOrderDetail.Dgv.Columns.Add("custOrddProfitUsd", "이익액(＄)");
            DgvOrderDetail.Dgv.Columns.Add("custOrddSize", "크기(Cm)");
            DgvOrderDetail.Dgv.Columns.Add("cutOrddvolumetricweight", "부피무게");
            DgvOrderDetail.Dgv.Columns.Add("custOrddweight", "무게");
            DgvOrderDetail.Dgv.Columns.Add("custOrddMemo", "비고");
            DgvOrderDetail.Dgv.Columns.Add("custOrddStatus", "상태");
            DgvOrderDetail.Dgv.Columns.Add("custOrddSeq", "순번");
            DgvOrderDetail.ApplyDefaultColumnSettings();
            
            DgvOrderDetail.Dgv.ScrollBars = ScrollBars.Both;
            ...
            DgvOrderDetail.Dgv.Columns["custOrddStatus"].Visible = false;
            DgvOrderDetail.Dgv.Columns["custOrddPdtCode"].Visible = false;
            DgvOrderDetail.Dgv.Columns["custOrddSeq"].Visible = false;
            DgvOrderDetail.Dgv.Columns["custOrddPdtNameKr"].ReadOnly = true;
            DgvOrderDetail.Dgv.Columns["custOrddPdtNameUs"].ReadOnly = true;
            DgvOrderDetail.Dgv.Columns["custorddPdtStatus"].ReadOnly = true;
            DgvOrderDetail.Dgv.Columns["custOrddPdtBprice"].ReadOnly = true;
            DgvOrderDetail.Dgv.Columns["custOrddPdtSprice"].ReadOnly = true;
            DgvOrderDetail.Dgv.Columns["custOrddProfitKrw"].ReadOnly = true;
            DgvOrderDetail.Dgv.Columns["custOrddProfitUsd"].ReadOnly = true;
            DgvOrderDetail.Dgv.Columns["custOrddSize"].ReadOnly = true;
            DgvOrderDetail.Dgv.Columns["custOrddweight"].ReadOnly = true;


            DgvOrderDetail.ApplyDefaultColumnSettings();
            DgvOrderDetail.Dgv.Rows.Add();
            DgvOrderDetail.Dgv.Rows[0].Cells[0].Value = 1;
        ...
        /// </summary>
        /// <param name="e"></param>
        private void ContextMenuSet(MouseEventArgs e)
        {
            columnsToToggle.Clear();
            //컨텍스트 메뉴에서 표기 제외 할 데이터 칼럼 설정
            List<string> excludColumn = new List<string> { "No", "custOrddPdtCode", "custOrddSeq","custOrddStatus" };
            foreach (DataGridViewColumn columnName in DgvOrderDetail.Dgv.Columns)
            {
            ...
            foreach (string columnName in columnsToToggle)
            {
                ...
                DataGridViewColumn column = DgvOrderDetail.Dgv.Columns[columnName];
            ...
            contextMenu.Show(DgvOrderDetail.Dgv, e.Location);
        ...
        /// <param name="e"></param>
        private void DgvOrderDetail_MouseRightClick(object sender, MouseEventArgs e)
        {
        ...
        private void Menu_Click(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            switch (clickedItemText)
            {
                ...
                default:
                    ...
                    if (DgvOrderDetail.Dgv.Columns.Contains(columnName))
                    {
                        var column = DgvOrderDetail.Dgv.Columns[columnName];
        ...
        /// <summary>
        /// 펼쳐보기 기능
        /// 데이터 그리드에 일부 제외한 칼럼외 모두 표시
        /// </summary>
        private void OnExpand()
        {
            foreach(string columnName in columnsToToggle)
            {
                DgvOrderDetail.Dgv.Columns[columnName].Visible = true;
            }
        ...
        private void OnCollapse()
        {
            ...
            foreach(string columnName in columnsToToggle)
            {
                DgvOrderDetail.Dgv.Columns[columnName].Visible = false;
            }
        ...
        {
            originalValues["@cordDate"] = orderDate ;
            originalValues["@cust"] = customerCode;
            originalValues["@address"] = tBoxAddress.Text;
            originalValues["@country"] = cmBoxCountry.SelectedIndex;
            originalValues["@status"] = orderStatus;
            originalValues["@sdate"] = saleDate;
            originalValues["@exchange"] = orderExchange;
            //originalValues["@shipping"] = ;
            //originalValues["@memo"] = memo;
        ...
        private void GridFill(DataTable dataTable)// 오늘은 요기까지
        {
            ...
            foreach (DataRow dataRow in dataTable.Rows)
            {
                ...
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtCode"].Value = dataRow["cordd_pdt"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNameKr"].Value = dataRow["pdt_name_kr"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNameUs"].Value = dataRow["pdt_name_en"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNumber"].Value = dataRow["pdt_number"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custorddPdtStatus"].Value = status;
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOrderQty"].Value = dataRow["cordd_orderqty"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtBprice"].Value = dataRow["cordd_bprice"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtSprice"].Value = dataRow["cordd_sprice"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value = dataRow["cordd_offerkrw"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceUsd"].Value = dataRow["cordd_offeruds"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteKrw"].Value = dataRow["cordd_amountkrw"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteUsd"].Value = dataRow["cordd_amountusd"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value = dataRow["cordd_offerqty"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddSize"].Value = size;
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddweight"].Value = dataRow["pdt_weight"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddMemo"].Value = dataRow["cordd_memo"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddStatus"].Value = dataRow["cordd_status"];
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddSeq"].Value = dataRow["cordd_seq"];
        ...
        private void SearchPdtNumberForCode(int index)
        {
            ...
            try
            {
                string query = string.Format("SELECT pdt_code FROM product WHERE pdt_number = '{0}' ", DgvOrderDetail.Dgv.CurrentRow.Cells["custOrddPdtNumber"].Value.ToString());
                object resultObj = new object();
                dbconn.sqlScalaQuery(query, out resultObj);
                //조회 결과가 없을 경우
                if (string.IsNullOrEmpty(resultObj?.ToString()))
                {
                    ...
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtCode"].Value = 0;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNameKr"].Value = DgvOrderDetail.Dgv.CurrentRow.Cells["custOrddPdtNumber"].Value;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNameUs"].Value = DgvOrderDetail.Dgv.CurrentRow.Cells["custOrddPdtNumber"].Value;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custorddPdtStatus"].Value = "미등록 제품";
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOrderQty"].Value = 1;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtBprice"].Value = 0;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtSprice"].Value = 0;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value = 0;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value = 0;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value = 1;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddSize"].Value = "";
                    DgvOrderDetail.Dgv.Rows[index].Cells["cutOrddvolumetricweight"].Value = 0;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddweight"].Value = 0;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddMemo"].Value = "";
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddStatus"].Value = 1;
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddSeq"].Value = index + 1;
                    AmountKrwSet(index);
                    AmountUsdSet(index);
                    OfferMarginSet(index);
                    ProfitSet(index);
                ...
                else
                {
                    ...
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNumber"].ReadOnly = true;
                }
                LastGridAdd();
            }
            catch (Exception ex)
        ...
        private void AddProductToGrid(int pdtCode, int index)
        {
            ...
            if (index == 0)
            {
                index = DgvOrderDetail.Dgv.RowCount - 1;
            }
            ...
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtCode"].Value = pdtCode;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNameKr"].Value = pdtNameEn;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNameUs"].Value = pdtNameKr;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtNumber"].Value = pdtNumber;
            DgvOrderDetail.Dgv.Rows[index].Cells["custorddPdtStatus"].Value = status;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOrderQty"].Value = 1;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtBprice"].Value = pdtBprice;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtSprice"].Value = pdtSpriceKrw;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value = pdtSpriceKrw;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceUsd"].Value = pdtSpriceUsd;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value = 1;
            
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddSize"].Value = size;
            DgvOrderDetail.Dgv.Rows[index].Cells["cutOrddvolumetricweight"].Value = "";
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddweight"].Value = weigth;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddStatus"].Value = 1;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddSeq"].Value = index+1;
        ...
        /// </summary>
        private void ChangedTheExchang()
        {
            int count = DgvOrderDetail.Dgv.RowCount;
            if (count > 1) 
            {
                DgvOrderDetail.Dgv.CellValueChanged -= DataGridCellChangedEvent;
        ...
        {
            if (DgvOrderDetail.Dgv.Rows.Count > 0)
            {
                DataGridViewRow lastRow = DgvOrderDetail.Dgv.Rows[DgvOrderDetail.Dgv.Rows.Count - 1];
        ...
        {
            int number = 1;
            for (int index = 0; index < DgvOrderDetail.Dgv.RowCount - 1; index++)
            {
                if (DgvOrderDetail.Dgv.Rows[index].Cells["custOrddStatus"].Value.ToString() == "1")
                {
                    DgvOrderDetail.Dgv.Rows[index].Cells["No"].Value = number;
                    number++;
                }
            }
        }
        ...
        private void DataGridCellChangedEvent(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if(!isEventProcessing)
            {
                ...
                try
                {
                    ...
                    string columnName = DgvOrderDetail.Dgv.Columns[DgvOrderDetail.Dgv.CurrentCell.ColumnIndex].Name;
                    switch (columnName)
                    {
        ...
        private bool ValueCheck(int index, string columnName)
        {
            ...
            string cellValue = DgvOrderDetail.Dgv.Rows[index].Cells[columnName].Value?.ToString();
            // 공백 또는 Null 여부 확인
            if (string.IsNullOrWhiteSpace(cellValue))
            {
                DgvOrderDetail.Dgv.Rows[index].Cells[columnName].Value = previousValue;// 이전 값으로 복원
            ...
            if (cellValue.ToString().Contains("-"))
            {
                ...
                DgvOrderDetail.Dgv.Rows[index].Cells[columnName].Value = cellValue;
            }
            return true;
        ...
        private void ChangedMargin(int index)
        {
            ...
            double cellValue = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddMargin"].Value);
            ...
            try
            {
                int cost = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddBprice"].Value);
                double price = cost / (1 - (cellValue * 0.01));
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value = cellValue;
                OfferPriceusdSet(index);
                AmountKrwSet(index);
                AmountUsdSet(index);
                ProfitSet(index);
            ...
            catch (Exception ex)
            {
                ...
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddMargin"].Value = "0";
            }
        }
        /// <summary>
        /// 주문수량 수정 시 이벤트
        ...
        {
            int cellValue = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOrderQty"].Value);
            ...
            try
            {
                int offerQty = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value);
                if(offerQty != 0)
                {
                    DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value = cellValue;
                }
            ...
            {
                MessageBox.Show("숫자 형식이 올바르지 않습니다. " + ex.Message, "오류");
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOrderQty"].Value = previousValue;
            }
        ...
        {
            int cellValue = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value);
            ...
            {
                MessageBox.Show("숫자 형식이 올바르지 않습니다. " + ex.Message, "오류");
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value = previousValue;
            }   
        }
        /// <summary>
        /// 제안단가(한화) 수정 시 이벤트 
        ...
        {
            int cellValue = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value);
            ...
            {
                MessageBox.Show("숫자 형식이 올바르지 않습니다. " + ex.Message, "오류");
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value = previousValue;
            }            
        }
        /// <summary>
        /// 제안단가(미화) 수정 시 이벤트
        ...
        {
            decimal cellValue = DgvOrderDetail.ConvertToDecimal(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceUsd"].Value);
            ...
            try
            {
                ...
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value = priceKrw;
            ...
            {
                MessageBox.Show("숫자 형식이 올바르지 않습니다. " + ex.Message, "오류");
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceUsd"].Value = previousValue;
            }            
        }
        /// <summary>
        /// 제안액(한화) 변경 시 이벤트
        ...
        {
            int cellValue = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteKrw"].Value);
            ...
            try
            {             
                int qty = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value);
            ...
            {
                MessageBox.Show("숫자 형식이 올바르지 않습니다. " + ex.Message, "오류");
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteKrw"].Value = previousValue;
            }
        }
        /// <summary>
        /// 제안액(미화) 수정시 이벤트
        ...
        {
            int cellValue = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteUsd"].Value);
            ...
            try
            {
                decimal qty = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value);
            ...
            {
                MessageBox.Show("숫자 형식이 올바르지 않습니다. " + ex.Message, "오류");
                DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteUsd"].Value = previousValue;
            }
        }
        ...
        {
            decimal priceKrw = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value);
            decimal priceUsd = priceKrw / orderExchange;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceUsd"].Value = priceUsd.ToString("#,##0.00");
        }
        /// <summary>
        /// 그리드 제안액 채우기
        /// </summary>
        ...
        {
            int price = Convert.ToInt32(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value);
            int qty = Convert.ToInt32(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value);
            int amount = price * qty;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteKrw"].Value = amount;
        }
        /// <summary>
        /// 그리드 제안액(미화) 채우기
        /// </summary>
        ...
        {
            decimal price = DgvOrderDetail.ConvertToDecimal(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteKrw"].Value);
            decimal amount = price / orderExchange;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteUsd"].Value = amount.ToString("#,##0.00");
        }
        /// <summary>
        /// 그리드 이익율 채우기
        /// </summary>
        ...
        {
            decimal cost = DgvOrderDetail.ConvertToDecimal(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtBprice"].Value);
            decimal price = DgvOrderDetail.ConvertToDecimal(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value);
            decimal maring = 0;
            if (cost == 0 && price == 0) 
            {
                maring = 0;
            ...
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddMargin"].Value = maring.ToString("#0.00");
        ...
        {
            int cost = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtBprice"].Value);
            int price = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPricekrw"].Value);
            int qty = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value);
            decimal porfit = (price * qty) - (cost * qty);
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddProfitKrw"].Value = porfit;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddProfitUsd"].Value = (porfit / orderExchange).ToString("#,##0.00");
        }
        /// <summary>
        /// 하단 텍스트박스 내용 채우기
        /// 전체 판매액과 이익율 등 계산
        ...
        {
            int dgrCounter = DgvOrderDetail.Dgv.RowCount-1;
            decimal price = 0; // 판매액
            ...
            {
                if (DgvOrderDetail.Dgv.Rows[i].Cells["custOrddOfferAmounteKrw"].Value.ToString() != "")
                {
                    price = price + DgvOrderDetail.ConvertToDecimal(DgvOrderDetail.Dgv.Rows[i].Cells["custOrddOfferAmounteKrw"].Value);
                }

                if (DgvOrderDetail.Dgv.Rows[i].Cells["custOrddPdtBprice"].Value.ToString() != "")
                {
                    purchase = purchase + (DgvOrderDetail.ConvertToDecimal(DgvOrderDetail.Dgv.Rows[i].Cells["custOrddPdtBprice"].Value) * DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[i].Cells["custOrddOfferQty"].Value));
                }
            }
            ...
            else
            {
                ...
                markupMargin = purchase == 0? 100 : fit / purchase * 100;
            }
            bprice = cost;
            amountKrw = Convert.ToInt32(totalPricekrw);
            amountUsd = totalPriceUsd;
        ...
        private void InsertCsutOrderVoucher(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            var shipping = cDataHandler.ConvertToInt(tBoxShippingKRW.Text);
            ...
            SqlParameter[] sqlParameter =
                {
                    ...
                    new SqlParameter("@staff", SqlDbType.Int ){Value = accessedEmp},
        ...
        private void InsertCustOrderDetail(SqlConnection connection, SqlTransaction transaction)
        {
            ...
            for (int index = 0; index < DgvOrderDetail.Dgv.RowCount - 1; index++)
            {
                ...
                var pdtCode = Convert.ToInt32(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtCode"].Value);
                var bPrice = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtBprice"].Value);
                var orderQty = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOrderQty"].Value);
                var sPrice = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddPdtSprice"].Value);
                var offerPriceKrw = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceKrw"].Value);
                var offerPriceUsd = DgvOrderDetail.ConvertToDecimal(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferPriceUsd"].Value);
                var offerQty = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value);
                var amountKrw = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteKrw"].Value);
                var amountUsd = DgvOrderDetail.ConvertToDecimal(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferAmounteUsd"].Value);
                var status = Convert.ToInt32(DgvOrderDetail.Dgv.Rows[index].Cells["custOrddStatus"].Value);
                var memoValue = DgvOrderDetail.Dgv.Rows[index].Cells["custOrddMemo"].Value?.ToString();
        ...
        private DataTable ConvertGridViewToDataTable(DataGridView gridView)
        {
            ...
            for (int i =0; i<DgvOrderDetail.Dgv.RowCount -1; i++)
            {
                if(DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[i].Cells["custOrddOfferQty"].Value) > 0)
                {
                    int qty = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.Rows[i].Cells["custOrddOfferQty"].Value);
                    if (qty >= 1)
                    {
                        DataRow dataRow = dataTable.NewRow();
                        dataRow["custOrddPdtCode"] = DgvOrderDetail.Dgv.Rows[i].Cells["custOrddPdtCode"].Value;
                        dataRow["custOrddOfferQty"] = DgvOrderDetail.Dgv.Rows[i].Cells["custOrddOfferQty"].Value;
                        dataRow["custOrddOfferAmounteKrw"] = DgvOrderDetail.Dgv.Rows[i].Cells["custOrddOfferAmounteKrw"].Value;
                        dataRow["custOrddOfferAmounteUsd"] = DgvOrderDetail.Dgv.Rows[i].Cells["custOrddOfferAmounteUsd"].Value;
        ...
        {
            DataTable prodcutData = ConvertGridViewToDataTable(DgvOrderDetail.Dgv);
        ...
        private void bntProductDelete_Click(object sender, EventArgs e)
        {
            ...
            int index = DgvOrderDetail.Dgv.CurrentRow.Index;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddStatus"].Value = 0;
            DgvOrderDetail.Dgv.Rows[index].Cells["custOrddOfferQty"].Value = 0;
            ChangedOfferQty(index);
            DgvOrderDetail.Dgv.Rows[index].Visible = false;
            SetTextBox();
            GridNumberSetting();
            ToggleEventHandler(false);
        }
        ...
        {
            if (DgvOrderDetail.Dgv.CurrentRow.Index == DgvOrderDetail.Dgv.Rows.Count - 1)//DataGrid의 마지막행은 항상 비어 있으므로 마지막행 선택시 메시지박스 표시
            {
            ...
            else
            {
                ...
                int pdtCode = DgvOrderDetail.ConvertToInt(DgvOrderDetail.Dgv.CurrentRow.Cells["custOrddPdtCode"].Value);
                ...
                else//등록되지 않은 제품의 경우 ProductDetail의 타입을 등록으로 호출하여 데이터 그리드에 있는 정보를 입력하여 한다
                {
                    ...
                    string pdtNumber = DgvOrderDetail.Dgv.CurrentRow.Cells["custOrddPdtNameUs"].Value.ToString();
                    string pdtBprice = DgvOrderDetail.Dgv.CurrentRow.Cells["custOrddPdtBprice"].Value.ToString();
