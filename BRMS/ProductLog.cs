...
namespace BRMS
{
    public partial class ProductLog : Form
    {
        ...
        {
            dgrLog.Dgv.Columns.Add("logPdtNake", "제품|분류명");
            dgrLog.Dgv.Columns.Add("logPdtNumber", "제품|분류번호");
        ...
        private void FillGrid(DataTable dataTable)
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                dgrLog.Dgv.Rows[addRow].Cells["logPdtNake"].Value = pdtName;
                dgrLog.Dgv.Rows[addRow].Cells["logPdtNumber"].Value = pdtNumber;
