...
namespace BRMS
{
    public partial class PaymentLog : Form
    {
        ...
        private void DataGridFrom()
        {
            ...
            dgrLog.Dgv.Columns.Add("logPayDate", "결제일");
            dgrLog.Dgv.Columns.Add("logParam", "전표코드");
        ...
        private void FillGrid(DataTable dataTable)
        {
            ...
            foreach (DataRow row in dataTable.Rows)
            {
                ...
                dgrLog.Dgv.Rows[addRow].Cells["logPayDate"].Value = payDate;
                dgrLog.Dgv.Rows[addRow].Cells["logParam"].Value = payCode;
